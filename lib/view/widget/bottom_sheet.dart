...
dynamic bottomSheet(BuildContext context,String title,description,getId){
  ValueNotifier<String> taskStack = ValueNotifier("New");
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: CustomButton(
                              onPressed: ()async{
                                loading.value = true;
                                switch(taskStack.value.toString()){
                                  case "New":
                                    {
